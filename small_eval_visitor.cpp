...
class EvalVisitor : public Visitor {
    ...
    public:
        ...
        void visit(EId *e) {
            tmp_value = eval_env.at(e->id());
        }

        void visit(EInt *e) {
            tmp_value = new VInt(e->value());
        }

        void visit(EFloat *e) {
            tmp_value = new VFloat(e->value());
        }

        void visit(EBool *e) {
            tmp_value = new VBool(e->value());
        }

        void visit(EChar *e) {
            tmp_value = new VChar(e->value());
        }

        void visit(EString *e) {
            tmp_value = new VString(e->value());
        }
        ...
        void visit(EIf *e) {
            ...
            VBool *clos = dynamic_cast<VBool*>(tmp_value);
            if (c == NULL)
